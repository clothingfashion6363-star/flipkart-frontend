  ...
  return (
    <html lang="en" className={`${roboto.variable} antialiased`}>
      <head>
        ...
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18348935840"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
              window.dataLayer = window.dataLayer || [];
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              s.parentNode.insertBefore(t,s)}(window, document,'script',
              'https://connect.facebook.net/en_US/fbevents.js');
              fbq('init', '1010612258405413');
              fbq('track', 'PageView');
            `,
          }}
        />
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=1010612258405413&ev=PageView&noscript=1" alt="" />
        </noscript>
      </head>
